...
async def ai_chat(req: AIRequest):
    try:
        ...
        system_instruction = (
            ...
            "4. НИКАКОЙ БАНАЛЬНОСТИ: Не задавай пустых вопросов вроде 'чем я могу вам помочь' после каждого ответа. Не читай лекции о морали и вежливости. Будь содержательным и конкретным."
        )
